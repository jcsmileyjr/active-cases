...
function ProgressionList(props){
  return(
    <div className="row instructionsContainer">
	  ...
	  <div className="col-xs-2 col-sm-5 col-md-5 col-lg-5">TBD</div>
	  ...
	  <div className="col-xs-10 col-sm-6 col-sm-offset-1 col-md-4 col-md-offset-3 col-lg-6 col-lg-offset-1">Judicial process </div>
	  <div className="col-xs-2 col-sm-5 col-md-5 col-lg-5">TBD</div>
	  ...
	  <div className="col-xs-10 col-sm-6 col-sm-offset-1 col-md-4 col-md-offset-3 col-lg-6 col-lg-offset-1">Sign, Close, and Filed</div>
